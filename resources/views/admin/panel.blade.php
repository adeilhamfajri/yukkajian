<div class="col-md-3 left_col">
  <div class="left_col scroll-view">
    <div class="navbar nav_title" style="border: 0;">
      <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Yuk Kajian !</span></a>
    </div>
      ...
      <div class="menu_section">
        ...
        <ul class="nav side-menu">
          ...
          <li><a><i class="fa fa-desktop"></i> Kajian <span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu">
              <li><a href="general_elements.html">Data Kajian</a></li>
              <li><a href="media_gallery.html">Tambah Kajian</a></li>
          ...
          <li><a><i class="fa fa-bar-chart-o"></i> Pertanyaan <span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu">
              <li><a href="chartjs.html">Data Pertanyaan</a></li>
